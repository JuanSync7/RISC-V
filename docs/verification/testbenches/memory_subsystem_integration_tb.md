# Module Design Document: memory_subsystem_integration_tb
...
| `mem_req_addr`     | output | `logic [ADDR_WIDTH-1:0]`                      | N/A                                           | N/A                                           | N/A                                 | N/A                                                                  |
...
### 6.3. `coherency_ctrl_inst` (`Cache Coherency Controller`)
